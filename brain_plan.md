...
### プロンプト変更方針
各ペルソナのキャラクターを維持しつつ、返答の末尾に必ず具体的なアイデア提案を一つ含める形に変更。

| ペルソナ | 変更前 | 変更後 |
|--------|--------|--------|
| ジョブズ | 何が足りないかを指摘する | 指摘の後に「だからこそ〜すべきだ」で具体提案を必ず追加 |
| 設計者 | 技術設計・手順に落とし込む | 「〜という方法が考えられる」形で実装アイデアを提案 |
| カオス | 前提を崩す視点を出す | 崩した後に「だったら〜はどうか」で奇抜な具体案を提案 |
